...
@section('content')
    <div class="main-body">
        <div class="main-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $item => $value)
                                    ...
                                    {{-- Modal Delete --}}
                                    <div class="modal fade" id="deleteModal{{ $value->produk_id }}" tabindex="-1"
            ...
            {{-- Modal --}}
            <div class="modal fade" id="addProdukModal" tabindex="-1" role="dialog" aria-labelledby="addProdukModalTitle"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="/administrator/product" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="deskripsi" placeholder="Tambahkan Deskripsi" name="deskripsi" rows="3"
                                        cols="10"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <p style="font-style: italic; font-size:smaller; color:red;">* format : pdf, jpg, jpeg;
                                        size : 1mb</p>
                                </div>
                                <div class="modal-footer">
